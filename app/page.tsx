    ...
    <>
      ...
      <main>
        <section className="home-hero">
          ...
          <div className="home-hero-copy">
            ...
            <div className="hero-actions">
              <Link className="button button-hot" href="/compass">Find your animal</Link>
              <Link className="button button-glass" href="/studio">Enter the studio</Link>
            </div>
          </div>
        ...
        <section className="portal-grid section-shell" aria-label="Explore the podcast">
          <Link className="portal-card portal-cyan" href="/concept"><span>THE BIG IDEA</span><h2>Why an animal changes everything</h2><p>Meet the premise, the rhythm and the values reset at the heart of the show.</p><strong>Follow the idea</strong></Link>
          <Link className="portal-card portal-coral" href="/segments"><span>SHOW BITS</span><h2>Recurring segments with teeth, wings and fins</h2><p>Fast, memorable beats for news, art, science, local life and beautiful chaos.</p><strong>Open the segment deck</strong></Link>
          <Link className="portal-card portal-gold" href="/ideas"><span>STORY SPARKS</span><h2>A whole island of episode ideas</h2><p>Local voices, visiting minds, artists, young people, older people and wild questions.</p><strong>Browse the sparks</strong></Link>
          <Link className="portal-card portal-violet" href="/studio"><span>WORKING STUDIO</span><h2>Turn a spark into a record-ready show</h2><p>Guest notes, episode maps, run sheets, source trails and a live recording cockpit.</p><strong>Start building</strong></Link>
        </section>
        ...
        <section className="closing-call section-shell">
          ...
          <Link className="text-link" href="/compass">Open the Animal Compass <span aria-hidden="true">&rarr;</span></Link>
        </section>
      </main>
      <SiteFooter />
    </>
